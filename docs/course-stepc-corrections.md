# STEP C — 강의(courses) 축 정정 2건 · ✅ **위임 실행 완료 · 독립검증 합격 (2026-08-25 밤)**

> **관제탑 독립검증 합격**: courses 15행 · kind=course 미연결 0 · started_on 5행 정정 ·
> 엄태현 paused · 김웅채 0행 — 전부 실측 일치. W-5 해소 승인.
> **직강 축 15명 전원 이관 완료.**
...
✅ 단위 검산 해소(관제탑 8/25 밤): **건 = 수업 회차(날짜×반) · 회 = 사람별 참석** —
「10건/20회」 둘 다 맞다. STEP D 발행 시 **`course_sessions` 10행 + `course_attendance`
20행** 대응이 되며, 발행문에 이 대응을 명시한다(추출본 대조 혼선 방지). 강의일정표
원본 기준 10건:
...
| 08-05 | 중급 | 박성민·양정현 |
| 08-06 | 중급 | 박성민·신종근 |
| 08-09 | 중급 | 박성민·양정현·길영패 |
| 08-10 | 중급 | 김준성·양정현·길영패 |
| 08-15 | 심화 | 김해주·양정현·길영패 |
| 08-17 | 중급 | 길영패 |
| 08-18 | 심화 | 김해주 |
| 08-22 | 심화 | 김해주·양정현·허혜민 |

박성민 +5 반영 시 미수 −90,000 → **−240,000**(W-8 판정 재료).
